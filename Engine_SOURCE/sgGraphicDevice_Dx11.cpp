...
//		dxgiDesc.BufferDesc.Format = DXGI_FORMAT::DXGI_FORMAT_B8G8R8A8_UNORM;
...
//
//		Microsoft::WRL::ComPtr<IDXGIDevice> pDXGDevice = nullptr;
//		Microsoft::WRL::ComPtr<IDXGIAdapter> pAdapter = nullptr;
//		Microsoft::WRL::ComPtr<IDXGIFactory> pFactory = nullptr;
//
//		if (FAILED(mDevice->QueryInterface(__uuidof(IDXGIDevice), (void**)pDXGDevice.GetAddressOf())))
//			return false;
//		
//		if (FAILED(pDXGDevice->GetParent(__uuidof(IDXGIAdapter), (void**)pAdapter.GetAddressOf())))
//			return false;
//
