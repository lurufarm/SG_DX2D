...
namespace sg
{
	...
	void Char_Lucy::Initialize()
	{
		...
		mAni->Create(L"Ani_Lucy_Idle", mAtlas, Vector2(0.0f, 0.0f), Vector2(22.0f, 21.0f), 7, Vector2::Zero, 0.05f);
		mAni->Create(L"Ani_Lucy_Move", mAtlas, Vector2(0.0f, 21.0f), Vector2(22.0f, 21.0f), 9, Vector2::Zero, 0.05f);
