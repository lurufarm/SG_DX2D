...
namespace sg
{
	...
	void Stage0_Forest03::Initialize()
	{
		...
		object::Instantiate<Img_Stage0_Map>(Img_Stage0_Map::Stage0::forestfd03, pos, eLayerType::BG, this);
		object::Instantiate<Img_StartingPlate>(mStartPos, eLayerType::BG, this);

		GameObject* Forest03camera = object::Instantiate<GameObject>(cameraPos, eLayerType::BG, this);
