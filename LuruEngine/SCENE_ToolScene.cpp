...
//namespace sg
//{
//	SCENE_ToolScene::SCENE_ToolScene()
//	{
//	}
//	SCENE_ToolScene::~SCENE_ToolScene()
//	{
//	}
//	void SCENE_ToolScene::Initialize()
//	{
//		Scene::Initialize();
//		TilePalette::Initialize();
//	}
//	void SCENE_ToolScene::Update()
//	{
//		Scene::Update();
//
...
//		}
//	}
//	void SCENE_ToolScene::LateUpdate()
//	{
//		Scene::LateUpdate();
//	}
//	void SCENE_ToolScene::Render()
//	{
//		Scene::Render();
//	}
//	void SCENE_ToolScene::OnEnter()
//	{
//	}
//	void SCENE_ToolScene::OnExit()
//	{
//	}
//}
//
...
//	case WM_CREATE:
//	{
//		std::shared_ptr <sg::Material> tile = sg::Resources::Find<sg::Material>(L"");
//		RECT rect = { 0, 0, tile->GetTexture()->GetWidth(), tile->GetTexture()->GetHeight() };
...
//
//		std::shared_ptr <sg::Material> tile = sg::Resources::Find<sg::Material>(L"");
//		BitBlt(hdc, 0, 0, tile->GetTexture()->GetWidth(), tile->GetTexture()->GetHeight(),
//			tile->Get)
//	}
//		{
//		default:
